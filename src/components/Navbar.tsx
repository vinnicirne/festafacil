    ...
    <header className="nav card navbar" style={{position:'sticky', top:0, zIndex:50, backdropFilter:'saturate(1.2) blur(6px)'}}>
      <div className="container navbar-inner">
        ...
        <div className="navbar-actions" style={{display:'flex', alignItems:'center', gap:'.5rem'}}>
          {isHome ? (
            <>
              <Link to="/painel/fornecedor" style={{fontSize:'.98rem', fontWeight:600, color:'#111', textDecoration:'none'}}>Fornecedores</Link>
              <Link to="/painel/usuario" className="btn btn-primary" style={{padding:'.4rem .8rem', borderRadius:12, display:'inline-flex', alignItems:'center', gap:'.4rem', textTransform:'none'}}>
                <UserIcon />
                Entrar
              </Link>
            </>
